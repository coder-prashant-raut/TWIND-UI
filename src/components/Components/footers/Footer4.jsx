        ...
        <div>
          ...
          <form className="mt-4 flex flex-col items-center md:items-start">
            <input
              ...
              className="w-full px-4 py-2 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-white"
            />
            <button className="mt-3 bg-white text-black px-6 py-2 rounded-md hover:bg-gray-200 transition-all">
              Subscribe
            </button>
          </form>
        </div>
...
export const footer4Code = `
  const Footer4 = () => {
    return (
      <footer className="relative bg-black text-white py-12 overflow-hidden">
        {/* Animated Gradient Background */}
        <div className="absolute inset-0 animate-gradient bg-gradient-to-r 
        from-purple-800 via-blue-600 to-green-500 opacity-20"></div>
        
        <div className="relative container mx-auto px-6 grid grid-cols-1 md:grid-cols-3
         gap-8 text-center md:text-left">
          ...
          <div>
            <h2 className="text-xl font-semibold">Stay Updated</h2>
            <form className="mt-4 flex flex-col items-center md:items-start">
              <input type="email" placeholder="Your email" className="w-full px-4 py-2 text-gray-800 
              rounded-md focus:outline-none focus:ring-2 focus:ring-white" />
              <button className="mt-3 bg-white text-black px-6 py-2 rounded-md hover:bg-gray-
