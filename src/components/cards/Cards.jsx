  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 py-10">
      ...
      <div className="bg-white shadow-lg rounded-xl p-6 sm:p-8">
        <h2 className="text-xl font-semibold text-gray-800">How to Use These Cards?</h2>
        ...
        <p className="text-gray-600 mt-3 text-sm sm:text-base">
          ...
          <code className="bg-gray-200 text-gray-800 px-2 py-1 rounded">npm install react tailwindcss lucide-react</code>
        </p>
      </div>
